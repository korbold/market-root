                ...
                <div class="order-info-details">
                    <div class="row mt-3">
                        ...
                        <div class="col-12">
                            ...
                            @if(!empty($address))
                            <h5>
                                {{translate('messages.contact_name')}} : {{isset($address['contact_person_name'])?$address['contact_person_name']:''}}
                            </h5>
                            <h5>
                    ...
                    <div class="checkout--info">
                        ...
                        @if ($order->payment_method != 'cash_on_delivery')
                            <div class="d-flex flex-row justify-content-between border-top">
                                <span>{{translate('messages.Paid by')}}: {{translate('messages.'.$order->payment_method)}}</span>	<span>{{translate('messages.amount')}}: {{$order->adjusment + $order->order_amount}}</span>	<span>{{translate('messages.change')}}: {{abs($order->adjusment)}}</span>
                            </div>
                        @endif
                    </div>
                </div>
