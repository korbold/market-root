            ...
            <div>
                <?php if(Request::is("admin/store/view/{$store->id}")): ?>
                    ...
                    <a href="<?php echo e(route('admin.store.edit',[$store->id])); ?>" class="btn btn--primary float-right">
                        <i class="tio-edit"></i> <?php echo e(translate('messages.edit')); ?> <?php echo e(translate('messages.store')); ?>

                    </a>
                    <?php else: ?>
                        <?php if(!isset($store->vendor->status)): ?>
                        <a class="btn btn--danger text-capitalize font-weight-bold float-right"
                        onclick="request_alert('<?php echo e(route('admin.store.application',[$store['id'],0])); ?>','<?php echo e(translate('messages.you_want_to_deny_this_application')); ?>')"
                        ...
                        onclick="request_alert('<?php echo e(route('admin.store.application',[$store['id'],1])); ?>','<?php echo e(translate('messages.you_want_to_approve_this_application')); ?>')"
    ...
    <!-- End Page Header -->
<?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/market-root/resources/views/admin-views/vendor/view/partials/_header.blade.php ENDPATH**/ ?>