            ...
            <div class="row align-items-center">
                <div class="col-xl-10 col-md-9 col-sm-8 mb-3 mb-sm-0 <?php echo e($parcel_order ? 'mb-2':''); ?>">
                    <h1 class="page-header-title text-capitalize m-0">
                        ...
                        <span>
                            <?php if($parcel_order): ?> <?php echo e(translate('messages.parcel')); ?> <?php echo e(translate('messages.orders')); ?>
                ...
                <div class="search--button-wrapper justify-content-end">
                    <form action="javascript:" id="search-form" class="search-form min--260">
                        ...
                        <div class="input-group input--group">
                            <input id="datatableSearch_" type="search" name="search" class="form-control h--40px"
                                    placeholder="<?php echo e(translate('messages.Ex:')); ?> 10010" aria-label="<?php echo e(translate('messages.search')); ?>" required>
                    ...
                    <div class="hs-unfold mr-2">
                        ...
                        <div id="usersExportDropdown"
                            ...
                            <a id="export-copy" class="dropdown-item" href="javascript:;" title="<?php echo e(translate('messages.current_page_only')); ?>">
                            ...
                            <a id="export-print" class="dropdown-item" href="javascript:;" title="<?php echo e(translate('messages.current_page_only')); ?>">
                                <img class="avatar avatar-xss avatar-4by3 mr-2"
                            ...
                            <span class="dropdown-header"><?php echo e(translate('messages.download')); ?> <?php echo e(translate('messages.options')); ?></span>
            ...
            <div class="table-responsive datatable-custom">
                <table id="datatable"
                    ...
                    <tr>
                        ...
                        <?php endif; ?>
                        <th class="border-0"><?php echo e(translate('messages.total')); ?> <?php echo e(translate('messages.amount')); ?></th>
                        <th class="text-center border-0"><?php echo e(translate('messages.order')); ?> <?php echo e(translate('messages.status')); ?></th>
                    ...
                    <?php $__currentLoopData = $orders; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=>$order): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        ...
                        <tr class="status-<?php echo e($order['order_status']); ?> class-all">
                            ...
                            <td>
                                ...
                                <?php else: ?>
                                    <label class="badge badge-danger"><?php echo e(translate('messages.invalid')); ?> <?php echo e(translate('messages.customer')); ?> <?php echo e(translate('messages.data')); ?></label>
                                <?php endif; ?>
                            </td>
                            <?php if($parcel_order): ?>
        ...
        <div id="datatableFilterSidebar" class="hs-unfold-content_ sidebar sidebar-bordered sidebar-box-shadow initial-hidden">
            <div class="card card-lg sidebar-card sidebar-footer-fixed">
                <div class="card-header">
                    <h4 class="card-header-title"><?php echo e(translate('messages.order')); ?> <?php echo e(translate('messages.filter')); ?></h4>
                ...
                <form class="card-body sidebar-body sidebar-scrollbar" action="<?php echo e(route('admin.order.filter')); ?>" method="POST" id="order_filter_form">
                    ...
                    <?php if(!$parcel_order): ?>
                        ...
                        <div class="mb-2 initial--21">
                            ...
                            <?php $__currentLoopData = \App\Models\Store::whereIn('id', $vendor_ids)->get(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $store): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    ...
                    <hr class="my-4">
                    <?php if($status == 'all'): ?>
                    <small class="text-cap mb-3"><?php echo e(translate('messages.order')); ?> <?php echo e(translate('messages.status')); ?></small>
                    ...
                    <?php if(!$parcel_order): ?>
                        <hr class="my-4">
                        <small class="text-cap mb-3"><?php echo e(translate('messages.order')); ?> <?php echo e(translate('messages.type')); ?></small>
                        <div class="custom-control custom-radio mb-2">
                    ...
                    <small class="text-cap mb-3"><?php echo e(translate('messages.date')); ?> <?php echo e(translate('messages.between')); ?></small>
...
<?php echo $__env->make('layouts.admin.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/market-root/resources/views/admin-views/order/list.blade.php ENDPATH**/ ?>