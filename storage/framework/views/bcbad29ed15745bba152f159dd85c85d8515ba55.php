            ...
            <div class="row align-items-center py-2">
                <div class="col-sm mb-2 mb-sm-0">
                    <div class="d-flex align-items-center">
                        <img onerror="this.src='<?php echo e(asset('/public/assets/admin/img/grocery.svg')); ?>'" src="<?php echo e(asset('storage/app/public/module')); ?>/<?php echo e($mod->icon); ?>" width="38" alt="img">
                        <div class="w-0 flex-grow pl-2">
                            <h1 class="page-header-title mb-0"><?php echo e($mod->module_name); ?> <?php echo e(translate('messages.Dashboard')); ?>.</h1>
                            <p class="page-header-text m-0"><?php echo e(translate('Hello, Here You Can Manage Your')); ?> <?php echo e($mod->module_name); ?> <?php echo e(translate('orders by Zone.')); ?></p>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-sm-auto min--280">
                    <select name="zone_id" class="form-control js-select2-custom"
                        ...
                        <option value="all"><?php echo e(translate('messages.All Zones')); ?></option>
                ...
                <div class="d-flex flex-wrap align-items-center justify-content-end">
                    <div class="status-filter-wrap">
                        <div class="statistics-btn-grp">
                            <label>
                                <input type="radio" name="statistics" value="this_year" <?php echo e($params['statistics_type'] == 'this_year'?'checked':''); ?> hidden onchange="order_stats_update(this.value)">
                                <span>This Year</span>
                            </label>
                            <label>
                                <input type="radio" name="statistics" value="this_month" <?php echo e($params['statistics_type'] == 'this_month'?'checked':''); ?> hidden onchange="order_stats_update(this.value)">
                                <span>This Month</span>
                            </label>
                            <label>
                                <input type="radio" name="statistics" value="this_week" <?php echo e($params['statistics_type'] == 'this_week'?'checked':''); ?> hidden onchange="order_stats_update(this.value)">
                                <span>This Week</span>
                            </label>
                        </div>
                    </div>
                                ...
                                <a class="order--card h-100" href="<?php echo e(route('admin.order.list',['failed'])); ?>">
                                    <div class="d-flex justify-content-between align-items-center">
                                        <h6 class="card-subtitle d-flex justify-content-between m-0 align-items-center">
                                            ...
                                            <span><?php echo e(translate('messages.payment')); ?> <?php echo e(translate('messages.failed')); ?></span>
                                        </h6>
                                        <span class="card-title text-danger">
...
<?php $__env->startPush('script_2'); ?>
    ...
    var options = {
          ...
          data: [<?php echo e($delivery_commission[1]); ?>,<?php echo e($delivery_commission[2]); ?>,<?php echo e($delivery_commission[3]); ?>,<?php echo e($delivery_commission[4]); ?>,<?php echo e($delivery_commission[5]); ?>,<?php echo e($delivery_commission[6]); ?>,<?php echo e($delivery_commission[7]); ?>,<?php echo e($delivery_commission[8]); ?>,<?php echo e($delivery_commission[9]); ?>,<?php echo e($delivery_commission[10]); ?>,<?php echo e($delivery_commission[11]); ?>,<?php echo e($delivery_commission[12]); ?>]
        }],
          chart: {
          height: 350,
          type: 'area',
...
<?php echo $__env->make('layouts.admin.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/market-root/resources/views/admin-views/dashboard-food.blade.php ENDPATH**/ ?>