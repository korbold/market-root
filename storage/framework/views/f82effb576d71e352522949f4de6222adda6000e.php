            ...
            <div class="d-flex justify-content-end">
                ...
                <ul class="list-inline list-separator">
                    <li class="list-inline-item">
                        <a class="list-separator-link" href="<?php echo e(route('admin.business-settings.business-setup')); ?>"><?php echo e(translate('messages.business')); ?> <?php echo e(translate('messages.setup')); ?></a>
                    </li>
...
<?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/market-root/resources/views/layouts/admin/partials/_footer.blade.php ENDPATH**/ ?>