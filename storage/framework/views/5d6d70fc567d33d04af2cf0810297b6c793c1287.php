            ...
            <div class="navbar-nav-wrap-content-right flex-grow-1 w-0">
                ...
                <ul class="navbar-nav align-items-center flex-row flex-grow-1 __navbar-nav">
                    ...
                    <li class="nav-item __nav-item">
                        <a href="<?php echo e(route('admin.users.dashboard')); ?>" id="tourb-6" class="__nav-link <?php echo e(Request::is('admin/users*') ? 'active' : ''); ?>">
                    ...
                    <li class="nav-item __nav-item">
                        <a href="<?php echo e(route('admin.transactions.store.withdraw_list')); ?>" id="tourb-7" class="__nav-link <?php echo e(Request::is('admin/transactions*') ? 'active' : ''); ?>">
                            <img src="<?php echo e(asset('/public/assets/admin/img/new-img/transaction-and-report.svg')); ?>" alt="public/img">
                            <span><?php echo e(translate('Transactions & Reports')); ?></span>
                        </a>
                    </li>

                    <li class="nav-item __nav-item">
                        <a href="<?php echo e(route('admin.business-settings.business-setup')); ?>" id="tourb-3" class="__nav-link <?php echo e(Request::is('admin/business-settings*') ? 'active' : ''); ?>">
                        ...
                        <div class="__nav-module" id="tourb-4">
                            ...
                            <div class="__nav-module-body">
                                <ul>
                                    ...
                                    <li>
                                        <a href="<?php echo e(route('admin.business-settings.module.index')); ?>" onclick="next_tour()">
                                            <img src="<?php echo e(asset('/public/assets/admin/img/navbar-setting-icon/module.svg')); ?>" alt="">
                                    ...
                                    <li>
                                        <a href="<?php echo e(route('admin.business-settings.zone.home')); ?>" onclick="next_tour()">
                                            <img src="<?php echo e(asset('/public/assets/admin/img/navbar-setting-icon/location.svg')); ?>" alt="">
                                    ...
                                    <li>
                                        <a href="<?php echo e(route('admin.business-settings.business-setup')); ?>" onclick="next_tour()">
                                            <img src="<?php echo e(asset('/public/assets/admin/img/navbar-setting-icon/business.svg')); ?>" alt="">
                                    ...
                                    <?php if(\App\CentralLogics\Helpers::module_permission_check('settings')): ?>
                                    <li>
                                        <a href="<?php echo e(route('admin.business-settings.config-setup')); ?>" onclick="next_tour()">
                                            <img src="<?php echo e(asset('/public/assets/admin/img/navbar-setting-icon/third-party.svg')); ?>" alt="">
                                            <span><?php echo e(translate('3rd Party')); ?></span>
                                        </a>
                                    </li>
                                    <li>
                                        <a href="<?php echo e(route('admin.business-settings.social-media.index')); ?>" onclick="next_tour()">
                                            <img src="<?php echo e(asset('/public/assets/admin/img/navbar-setting-icon/social.svg')); ?>" alt="">
                                ...
                                <div class="text-center mt-2">
                                    <a href="<?php echo e(route('admin.business-settings.business-setup')); ?>" onclick="next_tour()"><?php echo e(translate('View All')); ?></a>
                                </div>
                            </div>
                        </div>
                    </li>
                    ...
                    <li class="nav-item __nav-item">
                        <a href="<?php echo e(route('admin.dispatch.dashboard')); ?>" id="tourb-8" class="__nav-link <?php echo e(Request::is('admin/dispatch*') ? 'active' : ''); ?>">
                    ...
                    <li class="nav-item __nav-item">
                        <a href="javascript:void(0)" class="__nav-link module--nav-icon" id="tourb-0">
                            <?php if($mod): ?>   
                            <img src="<?php echo e(asset('storage/app/public/module')); ?>/<?php echo e($mod->icon); ?>" onerror="this.src='<?php echo e(asset('/public/assets/admin/img/new-img/module-icon.svg')); ?>'" width="20px" alt="public/img">
                            <?php else: ?>
                            <img src="<?php echo e(asset('/public/assets/admin/img/new-img/module-icon.svg')); ?>" alt="public/img">
                            <?php endif; ?>
                            <span class="text-white"><?php echo e($mod ? $mod->module_name : translate('modules')); ?></span>
                            <img  src="<?php echo e(asset('/public/assets/admin/img/new-img/angle-white.svg')); ?>" class="d-none d-lg-block ml-xl-2" alt="public/img">
                        </a>
                        <div class="__nav-module style-2" id="tourb-1">
                            ...
                            <div class="__nav-module-body">
                                <div class="__nav-module-items">
                                    <?php $__currentLoopData = $modules; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $module): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>   
                                        <a href="javascript:;" onclick="set_filter('<?php echo e(route('admin.dashboard')); ?>','<?php echo e($module->id); ?>','module_id')" class="__nav-module-item <?php echo e(Config::get('module.current_module_id') == $module->id?'active':''); ?>">
                                            <div class="img">
                                                <img src="<?php echo e(asset('storage/app/public/module')); ?>/<?php echo e($module->icon); ?>"
                                                onerror="this.src='<?php echo e(asset('public/assets/admin/img/new-img/module/e-shop.svg')); ?>'" 
                                                alt="new-img">
                                            </div>
                                            <div>
                                        ...
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                        <?php if(\App\CentralLogics\Helpers::module_permission_check('module')): ?>
                                        <a href="<?php echo e(route('admin.business-settings.module.create')); ?>" class="__nav-module-item" data-toggle="tooltip"
                            ...
                            <div class="__nav-module-body text-center py-5">
                                <img class="w--120px" src="<?php echo e(asset('/public/assets/admin/img/empty-box.png')); ?>" alt="">
                                <h2 class="my-4"><?php echo e(translate('Please, Enable or Create Module First')); ?></h2>
                                <a href="<?php echo e(route('admin.business-settings.module.index')); ?>" class="btn btn--primary"><?php echo e(translate('messages.Module Setup')); ?></a>
                            </div>
                            <?php endif; ?>
                        </div>
                    </li>
...
</div><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/market-root/resources/views/layouts/admin/partials/_header.blade.php ENDPATH**/ ?>