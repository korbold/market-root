    ...
    <div class="content container-fluid">
        ...
        <div class="page-header">
            <h1 class="page-header-title">
                ...
                <span>
                    <?php echo e(translate('messages.add').' '.translate('messages.new')); ?> <?php echo e(translate('messages.addon')); ?>
        ...
        <div class="card mt-1">
            <div class="card-header py-2 border-0">
                <div class="search--button-wrapper justify-content-end">
                    <h5 class="card-title"> <?php echo e(translate('messages.addon')); ?> <?php echo e(translate('messages.list')); ?><span class="badge badge-soft-dark ml-2" id="itemCount"><?php echo e($addons->total()); ?></span></h5>
                    <div class="min--220">
                    ...
                    <div>
                        <form id="search-form" class="search-form">
                            ...
                            <div class="input-group input--group">
                                <input id="datatableSearch" type="search" name="search" class="form-control min-height-45" placeholder="<?php echo e(translate('messages.ex_:_addons_name')); ?>" aria-label="Search addons">
                                ...
                                <td>
                                    <div class="btn--container justify-content-center">
                                        ...
                                        <a class="btn action-btn btn--danger btn-outline-danger"     href="javascript:"
                                            onclick="form_alert('addon-<?php echo e($addon['id']); ?>','<?php echo e(translate('Want to delete this addon ?')); ?>')" title="<?php echo e(translate('messages.delete')); ?> <?php echo e(translate('messages.addon')); ?>"><i class="tio-delete-outlined"></i></a>
        ...
        $(document).on('ready', function () {
          ...
          language: {
            zeroRecords: '<div class="text-center p-4">' +
                '<img class="mb-3 w-7rem" src="<?php echo e(asset('public/assets/admin/svg/illustrations/sorry.svg')); ?>" alt="Image Description">' +
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.admin.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/market-root/resources/views/admin-views/addon/index.blade.php ENDPATH**/ ?>