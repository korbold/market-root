<?php $__env->startSection('title',translate('Edit item')); ?>
    ...
    <div class="content container-fluid">
        ...
        <div class="page-header">
            <h1 class="page-header-title">
                ...
                <span>
                    <?php echo e(translate('messages.item_update')); ?>
            ...
            <div class="row g-2">
                    ...
                    <div class="card h-100">
                        ...
                        <div class="card-body">
                                ...
                                <?php $__currentLoopData = json_decode($language); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $lang): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    ...
                                    <div class="<?php echo e($lang != $default_lang ? 'd-none':''); ?> lang_form" id="<?php echo e($lang); ?>-form">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="name[]" id="<?php echo e($lang); ?>_name" class="form-control" placeholder="<?php echo e(translate('messages.new_food')); ?>" value="<?php echo e($translate[$lang]['name']??$product['name']); ?>" <?php echo e($lang == $default_lang? 'required':''); ?> oninvalid="document.getElementById('en-link').click()">
                                        </div>
                                        ...
                                        <div class="form-group pt-2 mb-0">
                                            ...
                                            <textarea type="text" name="description[]" class="form-control ckeditor min--height-200"><?php echo $translate[$lang]['description']??$product['description']; ?></textarea>
                                        </div>
                                    </div>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            <?php else: ?>
                            <div id="<?php echo e($default_lang); ?>-form">
                                <div class="form-group">
                                    <label class="input-label" for="exampleFormControlInput1"><?php echo e(translate('messages.name')); ?> (EN)</label>
                                    <input type="text" name="name[]" class="form-control" placeholder="<?php echo e(translate('messages.new_food')); ?>" value="<?php echo e($product['name']); ?>" required>
                                </div>
                                ...
                                <div class="form-group pt-2 mb-0">
                                    ...
                                    <textarea type="text" name="description[]" class="form-control ckeditor min--height-200"><?php echo $product['description']; ?></textarea>
                                </div>
                            </div>
                            <?php endif; ?>
                        </div>
                ...
                <div class="col-md-6">
                    <div class="card h-100">
                        ...
                        <div class="card-body">
                            <label class="input-label" for="exampleFormControlInput1"><?php echo e(translate('messages.item')); ?> <?php echo e(translate('messages.images')); ?></label>
                            <div>
                                <div class="row" id="coba">
                                    <?php $__currentLoopData = $product->images; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $photo): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <div class="col-xl-2 col-lg-3 col-md-4 col-sm-4 col-6 spartan_item_wrapper">
                                            <img class="img--square" src="<?php echo e(asset("storage/app/public/product/$photo")); ?>" alt="Product image">
                                            <a href="<?php echo e(route('admin.item.remove-image',['id'=>$product['id'],'name'=>$photo])); ?>"
                                                class="spartan_remove_row"><i class="tio-add-to-trash"></i></a>
                                        </div>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                </div>
                            </div>
                            <label class="text-dark mt-3"><?php echo e(translate('messages.item')); ?> <?php echo e(translate('messages.thumbnail')); ?> <small class="text-danger">* ( <?php echo e(translate('messages.ratio')); ?> 1:1 )</small></label>
                            ...
                            <div class="row g-2">
                                <div class="col-sm-6 col-lg-4">
                                    <div class="form-group mb-0">
                                        ...
                                        <select name="module_id" required class="form-control js-select2-custom"  data-placeholder="<?php echo e(translate('messages.select')); ?> <?php echo e(translate('messages.module')); ?>" onchange="modulChange(this.value)" disabled>
                                            ...
                                            <?php $__currentLoopData = \App\Models\Module::notParcel()->get(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $module): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <option value="<?php echo e($module->id); ?>" <?php echo e($module->id == $product->module_id?'selected':''); ?>><?php echo e($module->module_name); ?></option>
                                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                        </select>
                                    </div>
                                </div>
                                <div class="col-sm-6 col-lg-4">
                                    <div class="form-group mb-0">
                                        ...
                                        <select name="store_id" data-placeholder="<?php echo e(translate('messages.select')); ?> <?php echo e(translate('messages.store')); ?>" id="store_id" class="js-data-example-ajax form-control" onchange="getStoreData('<?php echo e(url('/')); ?>/admin/store/get-addons?data[]=0&store_id=', this.value,'add_on')"  title="Select Store" required oninvalid="this.setCustomValidity('<?php echo e(translate('messages.please_select_store')); ?>')">
                                        <?php if(isset($product->store)): ?>
                                        <option value="<?php echo e($product->store_id); ?>" selected="selected"><?php echo e($product->store->name); ?></option>
                                        <?php endif; ?>
                                        </select>
                                    </div>
                                </div>
                                ...
                                <div class="col-sm-6 col-lg-4">
                                    <div class="form-group mb-0">
                                        <label class="input-label" for="exampleFormControlSelect1"><?php echo e(translate('messages.sub_category')); ?><span
                                                class="input-label-secondary" title="<?php echo e(translate('messages.category_required_warning')); ?>"><img src="<?php echo e(asset('/public/assets/admin/img/info-circle.svg')); ?>" alt="<?php echo e(translate('messages.category_required_warning')); ?>"></span></label>
                                ...
                                <div class="col-sm-6 col-lg-4" id="stock_input">
                                    <div class="form-group mb-0">
                                        ...
                                        <input type="number" class="form-control" name="current_stock" value="<?php echo e($product->stock); ?>" id="quantity">
                                    </div>
                                </div>
                                <div class="col-sm-6 col-lg-4" id="addon_input">
                                    <div class="form-group mb-0">
                                        <label class="input-label" for="exampleFormControlSelect1"><?php echo e(translate('messages.addon')); ?><span
                                                class="input-label-secondary" title="<?php echo e(translate('messages.store_required_warning')); ?>"><img src="<?php echo e(asset('/public/assets/admin/img/info-circle.svg')); ?>" alt="<?php echo e(translate('messages.store_required_warning')); ?>"></span></label>
                                    ...
                                    <div class="form-group mb-0">
                                        ...
                                        <select name="unit" class="form-control js-select2-custom">
                                            <?php $__currentLoopData = \App\Models\Unit::all(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $unit): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <option value="<?php echo e($unit->id); ?>" <?php echo e($unit->id == $product->unit_id? 'selected':''); ?>><?php echo e($unit->unit); ?></option>
                                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                        </select>
                                    </div>
                                </div>
                                <div class="col-sm-6 col-lg-4" id="veg_input">
                                    <div class="form-group mb-0">
                                        ...
                                        <select name="veg" class="form-control js-select2-custom">
                                            <option value="0" <?php echo e($product['veg']==0?'selected':''); ?>><?php echo e(translate('messages.non_veg')); ?></option>
                                            <option value="1" <?php echo e($product['veg']==1?'selected':''); ?>><?php echo e(translate('messages.veg')); ?></option>
                                        </select>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row g-2">
                                <div class="col-sm-6 col-lg-4">
                                    <div class="form-group mb-0">
                                        ...
                                        <input type="number" value="<?php echo e($product['price']); ?>" min="0" max="999999999999.99" name="price"
                                ...
                                <div class="col-sm-6 col-lg-4">
                                    <div class="form-group mb-0">
                                        <label class="input-label" for="exampleFormControlInput1"><?php echo e(translate('messages.discount')); ?> <?php echo e(translate('messages.type')); ?><span class="input-label-secondary text--title" data-toggle="tooltip"
                        ...
                        <div class="card-body">
                            <div class="row g-2">
                                <div class="col-md-12" >
                                    ...
                                    <?php if(isset($product->food_variations)): ?>
                                        <?php $__currentLoopData = json_decode($product->food_variations,true); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key_choice_options=>$item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            ...
                                            <?php if(isset($item["price"])): ?>
                                                ...
                                                <?php break; ?>
                                            <?php else: ?>
                                                <?php echo $__env->make('admin-views.product.partials._new_variations',['item'=>$item,'key'=>$key_choice_options+1], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                                            <?php endif; ?>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                    <?php endif; ?>
                                    </div>
                            ...
                            <div class="row g-2">
                                    ...
                                    <div class="form-group mb-0">
                                        ...
                                        <select name="attribute_id[]" id="choice_attributes"
                                            ...
                                            <?php $__currentLoopData = \App\Models\Attribute::orderBy('name')->get(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $attribute): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <option value="<?php echo e($attribute['id']); ?>" <?php echo e(in_array($attribute->id,json_decode($product['attributes'],true))?'selected':''); ?>><?php echo e($attribute['name']); ?></option>
                                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                        </select>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-12">
                                    <div class="variant_combination" id="variant_combination">
                                        <?php echo $__env->make('admin-views.product.partials._edit-combinations',['combinations'=>json_decode($product['variations'],true),'stock'=>config('module.'.$product->module->module_type)['stock']], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div class="row g-2" id="time_input">
                                <div class="col-sm-6">
                                    <div class="form-group mb-0">
                                        <label class="input-label" for="exampleFormControlInput1"><?php echo e(translate('messages.available')); ?> <?php echo e(translate('messages.time')); ?> <?php echo e(translate('messages.starts')); ?></label>
                                        <input type="time" value="<?php echo e($product['available_time_starts']); ?>" name="available_time_starts" class="form-control" id="available_time_starts" placeholder="<?php echo e(translate('messages.Ex:')); ?> 10:30 am">
                                    </div>
                                </div>
                                <div class="col-sm-6">
                                    <div class="form-group mb-0">
                                        <label class="input-label" for="exampleFormControlInput1"><?php echo e(translate('messages.available')); ?> <?php echo e(translate('messages.time')); ?> <?php echo e(translate('messages.ends')); ?></label>
                                        <input type="time" value="<?php echo e($product['available_time_ends']); ?>" name="available_time_ends" class="form-control" id="available_time_ends" placeholder="5:45 pm">
                                    </div>
                                </div>
                            </div>
                        </div>
...
<script>
    ...
    var count= <?php echo e(isset($product->food_variations)?count(json_decode($product->food_variations,true)):0); ?>;
    ...
    $(document).ready(function(){
        ...
        <div class="card-header">
            <label for="" id=new_option_name_`+count+`> <?php echo e(translate('add new variation')); ?></label>
        </div>
        <div class="card-body">
            <div class="row g-2">
    ...
    //         <div class="col-8">
    //             <label for=""><?php echo e(translate('price')); ?></label>
    ...
    <script>
        ...
        $(document).ready(function () {
            ...
            getStoreData('<?php echo e(url('/')); ?>/admin/store/get-addons?<?php $__currentLoopData = json_decode($product['add_ons'], true); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $addon): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>data[]=<?php echo e($addon); ?>& <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?> store_id=','<?php echo e($product['store_id']); ?>','add_on');
            <?php else: ?>
            getStoreData('<?php echo e(url('/')); ?>/admin/store/get-addons?data[]=0&store_id=','<?php echo e($product['store_id']); ?>','add_on');
            <?php endif; ?>
        });
    </script>
    <script src="<?php echo e(asset('public/assets/admin')); ?>/js/tags-input.min.js"></script>
    <script>
        var module_id = <?php echo e($product->module_id); ?>;
        var module_type = "<?php echo e($product->module->module_type); ?>";
        if (module_type == 'food') {
        ...
        var stock = <?php echo e($product->module->module_type == 'food'? 'false':'true'); ?>;
    ...
    <script>
        $('#product_form').on('submit', function () {
            ...
            $.post({
                url: '<?php echo e(route('admin.item.update',[$product['id']])); ?>',
                ...
                success: function (data) {
                    ...
                    if (data.errors) {
                        ...
                        toastr.success('<?php echo e(translate("messages.product_updated_successfully")); ?>', {
                            CloseButton: true,
                            ProgressBar: true
                        });
                        setTimeout(function () {
                            location.href = '<?php echo e(\Request::server('HTTP_REFERER')??route('admin.item.list')); ?>';
                        }, 2000);
                    }
                }
            });
    ...
    <script type="text/javascript">
        var imageCount = <?php echo e(6-count($product->images)); ?>;
        if (imageCount > 0) {
...
<?php echo $__env->make('layouts.admin.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/market-root/resources/views/admin-views/product/edit.blade.php ENDPATH**/ ?>